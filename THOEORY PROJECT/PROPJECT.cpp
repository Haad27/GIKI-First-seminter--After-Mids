...
void student_login()
{
    ...
    do
    {
        ...
        cin >> temp_rollno;
        if (cin.fail())
        {                          // CIN.FAIL() MEANS THAT IF WRONG INPUT IS ENTER THE CONDITION WILLBE TRUE
        ...
        {
            if (temp_rollno > 0 && temp_rollno <= 10000)
            { // ROLL NO SHOULD BE LESS THAN 10000 TO  AVOID MESSING WITH ARRAYS
...
void view_student()
{
    do
    {
        ...
        { // chek if student exists with thhis rollno or not
